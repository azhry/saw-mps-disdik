                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <?php else: ?>
                            <a href="<?= base_url( 'login' ) ?>" onclick="window.location='<?= base_url( 'login' ) ?>';" class="nav-link dropdown-toggle text-muted waves-effect waves-dark" data-toggle="dropdown">Login</a>
                            <?php endif; ?>
                        </li>
                    </ul>
                </div>
